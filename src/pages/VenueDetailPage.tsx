...
const VenueDetailPage = () => {
  ...
  const reviewMutation = useMutation({
    mutationFn: (newReview: any) => reviewApi.createReview(newReview),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["venue-reviews", slug] });
      queryClient.invalidateQueries({ queryKey: ["venue", slug] });
      setNewComment("");
      setNewRating(5);
